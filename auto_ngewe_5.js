...
function reverseString(str) {return str.split("").reverse().join("");}var hardencryptedUrl=reverseString(encryptedUrl);
...
a_to_ve[i].href="https://www.inafut.com"+xxx+"?download="+ hardencryptedUrl;a_to_ve[i].rel="nofollow";a_to_ve[i].id="sedot";a_to_ve[i].target="_blank";a_to_vb++;a_to_vc+=i+":::"+ a_to_ve[i].href+"\n";}}
